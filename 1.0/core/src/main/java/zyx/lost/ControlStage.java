...
public class ControlStage extends Stage {
    ...
    public Image image_up = new Image(new TextureRegion(new Texture("ui/up.png")));
    public TextureRegionDrawable imageup[] = new TextureRegionDrawable[3];
    ...
    public void init_stage() {
        ...
        imageup[0]= new TextureRegionDrawable(new TextureRegion(new Texture("ui/up20.png")));
        imageup[1]= new TextureRegionDrawable(new TextureRegion(new Texture("ui/up21.png")));
        imageup[2]= new TextureRegionDrawable(new TextureRegion(new Texture("ui/up22.png")));
        ...
        image_attrack_near.setPosition(I.ScreenWidth - 300, I.ScreenHeight / 2);
